...
public class TaskFactory {
    ...
    public static final String GET_SEARCH_CAPABILITIES_ACTION = "GetSearchCapabilities";
    public static final int GET_SEARCH_CAPABILITIES_ACTION_I = 2;
    public static final String GET_SORT_CAPABILITIES_ACTION = "GetSortCapabilities";
    public static final int GET_SORT_CAPABILITIES_ACTION_I = 3;
    public static final String GET_SYSTEM_UPDATE_ID_ACTION = "GetSystemUpdateID";
    public static final int GET_SYSTEM_UPDATE_ID_ACTION_I = 4;
    public static final String SEARCH_ACTION = "Search";
    public static final int SEARCH_ACTION_I = 5;
